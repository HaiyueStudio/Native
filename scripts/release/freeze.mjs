...
import { root, manifestPath, readConfig, readJSON, command, selectedFiles, dependencies, verifyRelativeImports, verifyRubyLocks } from './common.mjs';
try {
  ...
  const candidate = {
    ...
    baselines: { Native: command('git', ['rev-parse', 'HEAD']) },
