...
3. Subscribe to snapshots and request a frame on changes. Refresh on app resume. Dispose with the host.
...
- Loading has a 45-second native SDK deadline. Once an ad or consent form is on screen, no JS timer forces rendering to resume behind it.
