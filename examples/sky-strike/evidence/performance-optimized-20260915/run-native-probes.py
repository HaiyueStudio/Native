...
out=Path('/Users/qingque/Desktop/HaiyueStudio/Native/examples/sky-strike/evidence/performance-optimized-20260915');out.mkdir(parents=True,exist_ok=True)
...
for name,mode,seconds in [('quantum','SKY_QUANTUM_PROBE',21),('fire','SKY_FIRE_PROBE',23),('black-hole','SKY_HOLE_PROBE',43),('prism','SKY_PRISM_PROBE',24),('parts','SKY_PARTS_PROBE',28)]:
