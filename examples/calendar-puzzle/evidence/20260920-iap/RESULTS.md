...
- iOS arm64 generic device Debug build, CODE_SIGNING_ALLOWED=NO: BUILD SUCCEEDED, includes HYCalendarStore.swift and Objective-C metadata. Final NativeScript iOS bundle prepared and rebuilt successfully. iPhone disconnected; no device install or real StoreKit checkout.
