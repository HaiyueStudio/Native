...
if(!existsSync(path.join(jdk,'bin/java'))||!existsSync(path.join(sdk,'platform-tools/adb')))throw new Error('Install JDK 21 and Android SDK, or set JAVA_HOME and ANDROID_HOME. See README.md.');
